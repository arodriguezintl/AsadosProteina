        ...
        const button = (
            <Comp
                ...
                className={cn(
                    ...
                    "data-[variant=default]:hover:bg-sidebar-accent/50",
                    "data-[variant=outline]:border data-[variant=outline]:border-sidebar-border data-[variant=outline]:hover:bg-sidebar-accent/50",
                    className
                )}
                {...props}
            />
